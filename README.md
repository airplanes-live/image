...
2. Boot the Pi, then install (in this order):
   - [wiedehopf/tar1090](https://github.com/wiedehopf/tar1090) — pulls in the `readsb` decoder and the live map
...
Recommended on Pi 4 and Pi 5. Pi 3 works but is borderline once you open a browser. Don't pair the desktop with the feeder stack on a Pi Zero 2 W (1 GB RAM) — use the headless image instead.
